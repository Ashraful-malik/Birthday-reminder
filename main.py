from tkinter import Label, Entry, Button, Tk, Frame, TOP, END
import sqlite3
...
def add_friend():
    ...
    cursor.execute("INSERT INTO birthday VALUES(:name_box,:birthday_box)",
                   {
...
frame.pack(side=TOP)
name_label = Label(frame, text="Name of your Friend",
                   font=" arial 20 italic", bg='#33ffbd', fg="blue")
Birthday_label = Label(frame, text="Birthday",
                       font=" arial 20 italic", bg='#33ffbd', fg="blue")
...
search_friend_box = Entry(
    frame, text="Add Friend Birthday", width=30, font=' Courier 13')

search_btn = Button(frame, text="SEARCH NAME", command=search_name,
                    font='Robot 10', bg='#34d2eb', relief='flat')
